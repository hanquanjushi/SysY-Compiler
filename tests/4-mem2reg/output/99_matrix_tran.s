...
tran:
	...
	addi.d $sp, $sp, -304
.tran_label_entry:
# %op9 = getelementptr float, float* %arg2, i32  1
	ld.d $t0, $fp, -40
	addi.w $t1, $zero, 1
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op10 = load float, float* %op9
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -100
# %op11 = getelementptr float, float* %arg7, i32  2
	ld.d $t0, $fp, -80
	addi.w $t1, $zero, 2
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# store float %op10, float* %op11
	...
	fld.s $ft0, $fp, -100
	fst.s $ft0, $t0, 0
# %op12 = getelementptr float, float* %arg1, i32  2
	ld.d $t0, $fp, -32
	addi.w $t1, $zero, 2
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op13 = load float, float* %op12
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -124
# %op14 = getelementptr float, float* %arg8, i32  1
	ld.d $t0, $fp, -88
	addi.w $t1, $zero, 1
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
	st.d $t0, $fp, -136
# store float %op13, float* %op14
	ld.d $t0, $fp, -136
	fld.s $ft0, $fp, -124
	fst.s $ft0, $t0, 0
# %op15 = getelementptr float, float* %arg1, i32  0
	ld.d $t0, $fp, -32
	addi.w $t1, $zero, 0
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op16 = load float, float* %op15
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -148
# %op17 = getelementptr float, float* %arg6, i32  1
	ld.d $t0, $fp, -72
	addi.w $t1, $zero, 1
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# store float %op16, float* %op17
	...
	fld.s $ft0, $fp, -148
	fst.s $ft0, $t0, 0
# %op18 = getelementptr float, float* %arg2, i32  0
	ld.d $t0, $fp, -40
	addi.w $t1, $zero, 0
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op19 = load float, float* %op18
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -172
# %op20 = getelementptr float, float* %arg6, i32  2
	ld.d $t0, $fp, -72
	addi.w $t1, $zero, 2
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# store float %op19, float* %op20
	...
	fld.s $ft0, $fp, -172
	fst.s $ft0, $t0, 0
# %op21 = getelementptr float, float* %arg0, i32  1
	ld.d $t0, $fp, -24
	addi.w $t1, $zero, 1
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op22 = load float, float* %op21
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -196
# %op23 = getelementptr float, float* %arg7, i32  0
	ld.d $t0, $fp, -80
	addi.w $t1, $zero, 0
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# store float %op22, float* %op23
	...
	fld.s $ft0, $fp, -196
	fst.s $ft0, $t0, 0
# %op24 = getelementptr float, float* %arg0, i32  2
	ld.d $t0, $fp, -24
	addi.w $t1, $zero, 2
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op25 = load float, float* %op24
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -220
# %op26 = getelementptr float, float* %arg8, i32  0
	ld.d $t0, $fp, -88
	addi.w $t1, $zero, 0
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# store float %op25, float* %op26
	...
	fld.s $ft0, $fp, -220
	fst.s $ft0, $t0, 0
# %op27 = getelementptr float, float* %arg1, i32  1
	ld.d $t0, $fp, -32
	addi.w $t1, $zero, 1
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op28 = load float, float* %op27
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -244
# %op29 = getelementptr float, float* %arg7, i32  1
	ld.d $t0, $fp, -80
	addi.w $t1, $zero, 1
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
	st.d $t0, $fp, -256
# store float %op28, float* %op29
	ld.d $t0, $fp, -256
	fld.s $ft0, $fp, -244
	fst.s $ft0, $t0, 0
# %op30 = getelementptr float, float* %arg2, i32  2
	ld.d $t0, $fp, -40
	addi.w $t1, $zero, 2
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op31 = load float, float* %op30
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -268
# %op32 = getelementptr float, float* %arg8, i32  2
	ld.d $t0, $fp, -88
	addi.w $t1, $zero, 2
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# store float %op31, float* %op32
	...
	fld.s $ft0, $fp, -268
	fst.s $ft0, $t0, 0
# %op33 = getelementptr float, float* %arg0, i32  0
	ld.d $t0, $fp, -24
	addi.w $t1, $zero, 0
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
...
# %op34 = load float, float* %op33
	...
	fld.s $ft0, $t0, 0
	fst.s $ft0, $fp, -292
# %op35 = getelementptr float, float* %arg6, i32  0
	ld.d $t0, $fp, -72
	addi.w $t1, $zero, 0
	slli.d $t1, $t1, 2
	add.d $t0, $t0, $t1
	st.d $t0, $fp, -304
# store float %op34, float* %op35
	ld.d $t0, $fp, -304
	fld.s $ft0, $fp, -292
	fst.s $ft0, $t0, 0
# ret i32  0
...
# %op38 = getelementptr [3 x float], [3 x float]* %op0, i32  0, i32  0
	...
	addi.d $t2, $t0, 0
	st.d $t2, $fp, -424
# %op39 = call i32  @tran(float* %op30, float* %op31, float* %op32, float* %op33, float* %op34, float* %op35, float* %op36, float* %op37, float* %op38)
# br label %label40
	ld.w $t0, $fp, -428
	st.w $t0, $fp, -432
	b .main_label40
